...
namespace bitpit {
     ...
     * \param[in] L Length of the side in physical domain (X,Y,Z),
     * \param[in] dim The space dimension of the octree.
     * \param[in] logfile The file name for the log of this object. PABLO.log is the default value.
     */
#if BITPIT_ENABLE_MPI==1
    ...
    */
     ...
     */
    void
    PabloNonUniform::setOrigin(const darray3 &origin){
        m_origin = origin;
    };
     ...
     */
    void
    PabloNonUniform::write(const std::string &filename) {
     ...
     */
    void
    PabloNonUniform::writeTest(const std::string &filename, vector<double> data) {
