...
/*!
	...
	communicator.
*/
void VolOctreeNonUniform::initializeTreePartitioning()
{
...
/*!
	...
	cells halo
*/
void VolOctreeNonUniform::initializeTreeHaloSize(std::size_t haloSize)
{
...
/*!
	...
	communications.
*/
void VolOctreeNonUniform::setCommunicator(MPI_Comm communicator)
{
...
*/
int VolOctreeNonUniform::getCellHaloLayer(long id) const
{
...
/*!
	...
	ghost cells halo.
*/
std::size_t VolOctreeNonUniform::_getMaxHaloSize()
{
...
/*!
	...
	cells halo
*/
void VolOctreeNonUniform::_setHaloSize(std::size_t haloSize)
{
...
*/
std::vector<adaption::Info> VolOctreeNonUniform::_partitioningPrepare(const std::unordered_map<long, double> &cellWeights, double defaultWeight, bool trackPartitioning)
{
...
*/
std::vector<adaption::Info> VolOctreeNonUniform::_partitioningAlter(bool trackPartitioning)
{
	std::vector<adaption::Info> partitioningData;
...
*/
void VolOctreeNonUniform::_partitioningCleanup()
{
...
*/
std::vector<long> VolOctreeNonUniform::_findGhostCellExchangeSources(int rank)
{
...
/*!
	...
	for which an explicit weight has not been defined
*/
void VolOctreeNonUniform::computePartitioningOctantWeights(const std::unordered_map<long, double> &cellWeights, double defaultWeight)
{
...
/*!
	Compute partitioning weights for the octants.
*/
void VolOctreeNonUniform::clearPartitioningOctantWeights()
{
